...
- `expect.Console` is created with [xpty](https://github.com/ActiveState/xpty) allowing testing of applications that want to talk to an `xterm`-compatible terminal
